...
exports.runOrWarnPackageManagerInstall = exports.isYarn = exports.getPackageManagerInstallCmd = exports.getRunScriptCmd = exports.getPackageManager = exports.pmRunScriptCmd = exports.pmInstallCmd = exports.pmMarkFiles = void 0;
...
exports.runOrWarnPackageManagerInstall = function (workingDir, doRun) {
    ...
    if (doRun) {
        ...
        child_process_1.execSync(pkgMgrCmd, __assign({ cwd: workingDir }, execLoudOptions));
    }
    else {
        // console.log(
